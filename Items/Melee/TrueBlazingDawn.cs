...
namespace AAMod.Items.Melee
{
    public class TrueBlazingDawn : BaseAAItem
	{
        ...
        public override void MeleeEffects(Player player, Rectangle hitbox)
        {
            ...
            {
                Dust dust;
                dust = Main.dust[Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 46, default, 1.381579f)];
                dust.noGravity = true;
            }
        }
