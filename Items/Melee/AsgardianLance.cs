...
namespace AAMod.Items.Melee
{
    public class AsgardianLance : BaseAAItem
	{
        ...
        {
            Projectile.NewProjectile(position, new Vector2(speedX, speedY), Terraria.ModLoader.ModContent.ProjectileType<Projectiles.AsgardianLanceShot>(), damage, knockBack, item.owner);
            return true;
        }
