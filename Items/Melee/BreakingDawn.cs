...
namespace AAMod.Items.Melee
{
    public class BreakingDawn : BaseAAItem
    {
        ...
        {
            Dust dust;
            dust = Dust.NewDustDirect(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, Terraria.ModLoader.ModContent.DustType<Dusts.StarDust>(), 0f, 0f, 46, default, 1.25f);
			dust.noGravity = true;
        }
	}
}
