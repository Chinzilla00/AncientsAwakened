...
Horseman's Blade EX");
		...
		public override void OnHitNPC(Player player, NPC target, int damage, float knockBack, bool crit)
        {
            ...
            velocityX *= num6;
            velocityY *= num6;
            Projectile p = Projectile.NewProjectileDirect(new Vector2(screenX, screenY), new Vector2(velocityX, velocityY), Terraria.ModLoader.ModContent.ProjectileType<Projectiles.Apocalypse>(), damage, 0f, player.whoAmI);
            p.tileCollide = false;
