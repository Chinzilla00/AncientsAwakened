    ...
    public class DragonFang : BaseAAItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                item.autoReuse = true;
                item.channel = false;
                item.shoot = Terraria.ModLoader.ModContent.ProjectileType<Projectiles.AsgardianIce>();
            }
            else
            {
                item.noMelee = true;
                ...
                item.channel = true;
                item.shoot = Terraria.ModLoader.ModContent.ProjectileType<Projectiles.ValkyrieSlash>();
            }
