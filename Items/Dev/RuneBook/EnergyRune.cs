...
namespace AAMod.Items.Dev.RuneBook
{
    public class EnergyRune : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            bool flag64 = projectile.type == mod.ProjectileType("EnergyRune");
            ...
            {
                bool flag23 = Main.projectile[num638].type == mod.ProjectileType("EnergyRune");
            ...
            if (projectile.ai[0] == 0f)
            {
				...
				if (flag25 && projectile.ai[1] == 0f)
				{
					...
					if (Main.myPlayer == projectile.owner && Collision.CanHitLine(projectile.position, projectile.width, projectile.height, vector46, 0, 0))
					{
						...
						int num659 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value19.X, value19.Y, num658, (int)(projectile.damage), 0f, Main.myPlayer, 0f, 0f);
