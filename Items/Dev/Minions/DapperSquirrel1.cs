                ...
                else
                {
                    ...
                    else if (num64 >= 0 && num62 < 800f + num57)
                    {
                        ...
                        else if (projectile.owner == Main.myPlayer)
                        {
                            ...
                            int num81 = Projectile.NewProjectile(vector8.X, vector8.Y, num75, num77, num80, num79, projectile.knockBack, Main.myPlayer, 0f, ownerMinionAttackTargetNPC.whoAmI);
