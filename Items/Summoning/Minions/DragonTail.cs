    ...
    public class DragonTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.alpha > 0)
                ...
                {
                    int num1055 = Dust.NewDust(projectile.position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 100, default, 2f);
