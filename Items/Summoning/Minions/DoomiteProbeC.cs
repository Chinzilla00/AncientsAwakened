...
namespace AAMod.Items.Summoning.Minions
{
    public class DoomiteProbeC : ModProjectile
	{
        ...
        {
            bool flag64 = projectile.type == mod.ProjectileType("DoomiteProbeC");
            Player player = Main.player[projectile.owner];
            AAPlayer modPlayer = player.GetModPlayer<AAPlayer>();
            player.AddBuff(mod.BuffType("DoomiteProbeC"), 3600);
            if (flag64)
            {
                if (player.dead)
                {
            ...
            {
                bool flag23 = Main.projectile[num638].type == mod.ProjectileType("DoomiteProbeC");
