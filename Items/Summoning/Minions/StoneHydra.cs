    ...
    public class StoneHydra : ModProjectile
    {
        ...
        public override void AI()
        {
            if (projectile.localAI[0] == 0f)
            {
                ...
                {
                    int num503 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 16f), projectile.width, projectile.height - 16, 185, 0f, 0f, 0, default(Color), 1f);
            ...
            if (flag18)
            {
                ...
                if (projectile.ai[0] <= 0f)
                {
                    ...
                    {
                        float num521 = 6f;
                        int num522 = mod.ProjectileType("BogBomb");
