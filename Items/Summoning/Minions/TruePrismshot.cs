    ...
    internal class TruePrismshot : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int num443 = 0; num443 < 2; num443++)
            {
                ...
                projectile.alpha = 255;
                int num444 = Dust.NewDust(vector31, 1, 1, Terraria.ModLoader.ModContent.DustType<Dusts.HallowedDustT>(), 0f, 0f, 0);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num586 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadB>(), 0f, 0f, 50, Main.DiscoColor);
