...
namespace AAMod.Items.Summoning.Minions
{
    internal class TruePrismshot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num111 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 66, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 1.5f);
