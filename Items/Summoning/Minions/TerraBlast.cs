...
namespace AAMod.Items.Summoning.Minions
{
    public class TerraBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust20 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType<Dusts.TMagicDust>(), 0f, 0f, 0)];
            ...
            dust20 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType<Dusts.TMagicDust>(), 0f, 0f, 0)];
            dust20.position = position;
            dust20.velocity = (projectile.velocity.RotatedBy(-1.5707963705062866) * 0.33f) + (projectile.velocity / 4f);
            dust20.position += projectile.velocity.RotatedBy(-1.5707963705062866);
            dust20.fadeIn = 0.5f;
