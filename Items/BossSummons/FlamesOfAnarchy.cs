...
Non-Consumable");
        ...
        public override bool UseItem(Player player)
        {
            ...
            {
                if (Main.netMode != 1) BaseMod.BaseUtility.Chat("Again..!? Didin't you learn from last time? Oh well, I'm gonna have a ball blasting you to shreds!", new Color(102, 20, 48));

                AAModGlobalNPC.SpawnBoss(player, mod.NPCType("Ashe"), false, -1, 0, "Ashe Akuma", false);

                if (Main.netMode != 1) BaseMod.BaseUtility.Chat("Whatever, let's just get this over with.", new Color(72, 78, 117));
            ...
            {
                if (Main.netMode != 1) BaseMod.BaseUtility.Chat("Sigh... Here we go again...", new Color(72, 78, 117));

                if (Main.netMode != 1) BaseMod.BaseUtility.Chat("THIS TIME I'M NOT LOSING! You're gonna feel the taste of defeat you disgusting warm-blood!", new Color(102, 20, 48));
                AAModGlobalNPC.SpawnBoss(player, mod.NPCType("Ashe"), false, -1, 0, "Ashe Akuma", false);
                AAModGlobalNPC.SpawnBoss(player, mod.NPCType("Haruka"), false, 1, 0, "Haruka Yamata", false);
                return true;
            }
