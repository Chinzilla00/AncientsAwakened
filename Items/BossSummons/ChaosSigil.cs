...
Non-Consumable");
        ...
        public override bool UseItem(Player player)
        {
            ...
            {
                BaseMod.BaseUtility.Chat(AAWorld.downedShen ? "Big mistake, child..." : "Hmpf...again..? Alright, let's just get this done and overwith.", Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
