...
{
	public class ImpSlave : ModProjectile
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Imp Slave");
        ...
        public override void AI()
        {
            ...
            if (player.dead)
            {
                modPlayer.ImpSlave = false;
            }
            if (modPlayer.ImpSlave)
            {
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                int num29 = mod.ProjectileType<ShadowflameBeam>();
