...
namespace AAMod.Items.Armor.Champion
{
    public class BaronBunny : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num658 = ModContent.ProjectileType<Projectiles.Rajah.Supreme.RabbitBeam>();
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D Mad = mod.GetTexture("Items/Armor/Champion/BaronMad");
            Texture2D Eyes = mod.GetTexture("Items/Armor/Champion/BaronMadEyes");
            Texture2D Meter = mod.GetTexture("Items/Armor/Champion/BaronBunnyMeter");
            Texture2D MeterGlow = mod.GetTexture("Items/Armor/Champion/BaronBunnyMeter_Glow");
