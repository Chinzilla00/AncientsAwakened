...
50% chance to not consume ammo");
	    ...
	    public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
		    ...
		    Projectile.NewProjectile(position.X, position.Y, SpeedX, SpeedY, Terraria.ModLoader.ModContent.ProjectileType<Moonblow>(), (int)(damage * 1.5f), knockBack, player.whoAmI, 0.0f, 0.0f);
		    for (int i = 0; i <= 6; i++)
		    {
