    ...
    public class Gigataser : BaseAAItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            for (int num842 = 0; num842 < 3; num842++)
            {
                ...
                Projectile.NewProjectile(position.X, position.Y, vector83.X * 2, vector83.Y * 2, Terraria.ModLoader.ModContent.ProjectileType<Projectiles.Zero.ZeroTaze>(), damage, 0f, Main.myPlayer, vector82.ToRotation(), ai);
            }
            return false;
        }
