...
namespace AAMod.Items.Boss.Athena
{
    public class RazorwindLongbow : BaseAAItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                Projectile.NewProjectile(position.X, position.Y, speedX, speedX, ModContent.ProjectileType<Projectiles.Athena.WindArrow>(), damage, knockBack * 3, player.whoAmI, 0f, 0f);
                return false;
            }
            return true;
        }
