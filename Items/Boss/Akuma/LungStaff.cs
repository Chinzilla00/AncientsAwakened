    ...
    public class LungStaff : BaseAAItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num186 = 0; num186 < 1000; num186++)
            {
                ...
                {
                    if (num184 == -1 && Main.projectile[num186].type == Terraria.ModLoader.ModContent.ProjectileType<LungHead>())
                    {
                        num184 = num186;
                    }
                    if (num185 == -1 && Main.projectile[num186].type == Terraria.ModLoader.ModContent.ProjectileType<LungTail>())
                    {
                        num185 = num186;
                    }
            ...
            if (num184 == -1 && num185 == -1)
            {
                ...
                num187 = Projectile.NewProjectile(vector2.X, vector2.Y, num81, num82, Terraria.ModLoader.ModContent.ProjectileType<LungBody>(), num76, num77, Main.myPlayer, num187, 0f);
                int num188 = num187;
                ...
                num187 = Projectile.NewProjectile(vector2.X, vector2.Y, num81, num82, Terraria.ModLoader.ModContent.ProjectileType<LungTail>(), num76, num77, Main.myPlayer, num187, 0f);
                Main.projectile[num188].localAI[1] = num187;
            }
            return false;
        }
