    ...
    internal class AARecipes
    {
        ...
        public static void AddRecipeGroups()
        {
            ...
            RecipeGroup group7 = new RecipeGroup(getName: () => Language.GetTextValue("LegacyMisc.37") + " hardmode forge", validItems: new int[]
            {
                ...
                AAMod.instance.ItemType("TechneciumForge")
            });
            RecipeGroup.RegisterGroup("AnyHardmodeForge", group7);

            RecipeGroup group8 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " chaos claw", new int[]
            {
            ...
            RecipeGroup group9 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " iron bar", new int[]
            {
                ItemID.IronBar,
                ItemID.LeadBar
            });
            ...
            RecipeGroup group10 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " copper bar", new int[]
            {
                ItemID.CopperBar,
                ItemID.TinBar
            });
            ...
            RecipeGroup group11 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " silver bar", new int[]
            {
                ItemID.SilverBar,
                ItemID.TungstenBar
            });
            ...
            RecipeGroup group12 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " evil bar", new int[]
            {
                ItemID.DemoniteBar,
                ItemID.CrimtaneBar
            });
            ...
            RecipeGroup group13 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " chaos bar", new int[]
            {
            ...
            RecipeGroup group14 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " evil/chaos bar", new int[]
            {
                ItemID.DemoniteBar,
                ItemID.CrimtaneBar,
                AAMod.instance.ItemType("IncineriteBar"),
            ...
            RecipeGroup group15 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " ancient crafting station", new int[]
            {
            ...
            {
                AAMod.instance.ItemType<Items.Summoning.EaterStaff>(),
                AAMod.instance.ItemType<Items.Summoning.CrimsonStaff>()
            });
            RecipeGroup.RegisterGroup("AAMod:EvilStaff", group16);

            RecipeGroup group17 = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " altar", new int[]
            {
