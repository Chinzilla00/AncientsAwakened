...
Ой, кажется, я использовал свое рунное перо для этого. Ну, теперь она волшебная.";
                        ...
                        case "downedFAnubisY":
                        return "Ты неплохо справился, приятель. Я впечатлен, хотя я все еще не использовал все свои силы. А? Моя полная сила? Как я сказал до этого, некоторые вещи должны быть скрыты от тебя.";
                        case "downedFAnubisN1":
                        return "Я хочу реванш, ";
                        case "downedFAnubisN2":
                        return ". Не из-за гордыни. Я должен быть уверен, что ты готов к тому, что тебя ждет впереди. Сразись со мной снова.";
                        case "downedGreedAY":
