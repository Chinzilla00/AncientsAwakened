            ...
            if(Language.ActiveCulture == GameCulture.Chinese)
            ...
            else if(Language.ActiveCulture == GameCulture.Russian)
                {
                    switch(Greed)
                    {
                        ...
                        case "GreedChest3":
                        return "УБРАЛ РУКИ ОТ МОИХ ПРЕЛЕСТЕЙ, ТЫ, ВОРОВСКАЯ ОБЕЗЬЯНА!";
                    }
                }
            else
                {
...
Ой, кажется, я использовал свое рунное перо для этого. Ну, теперь она волшебная.";
                        ...
                        return "... и все? ";
                        case "downedMonarchN":
                        return "Эй, видел эти маленькие красные грибы повсюду? Я слышал, что если объединить их в одну массу и помахать немного, то придет их король и попытается тебя убить. Я обязан его увидеть. ";
                        case "downedFungusY":
                        return "Хорошая работа. А теперь честно, ты сейчас на грибах? ";
                        case "downedFungusN":
                        return "Пещеры светящихся грибов всегда заставляли меня чувствовать себя странно по какой-то причине. В любом случае, хочешь магические способности получше? Там обитает огромный гриб-монстр, в котором сокрыты отличные возможности для улучшения своей магии. Просто не забудь заткнуть свой нос, пока ты там. ";
                        case "downedGripsY":
                        ...
                        case "downedHydraN":
                        return "Трясина всегда была местом собрания для всех самых омерзительных тварей, но там есть одна большая, и у нее 3 головы. Всегда ворчливая, и неважно, когда я пытаюсь зайти к ней в логово, она всегда пытается СЪЕСТЬ меня!";
                        case "downedDjinnY":
                        ...
                        case "downedSerpentN":
                        return "Змеи! И откуда там только змеи? Я ненавижу их! В любом случае, недавно, в тундре, мне встретились снежные змеи, которые не оставляют меня в покое. Можешь поиграть в истребителя и узнать по пути, что они делали? ";
                        case "downedRetrieverY":
                        ...
                        case "downedRaiderN":
                        return "Люди говорили, что видели в небе огромную тень ночью. Она была настолько большая, что закрыла собой всю Луну на секунду. Ты должен разгадать эту тайну и сделать что-нибудь. ";
                        case "downedOrthrusY":
                        return "Я думаю, что Орф-X сейчас - это то, что он ест... Что я сейчас ляпнул? Сам без понятия. ";
                        case "downedOrthrusN":
                        ...
                        case "downedAnubisBY":
                        return "Мог быть и помягче со мной, знаешь ли. До сих пор спина болит.";
                        case "downedAnubisBN":
                        ...
                        case "downedAthenaN":
                        return "Ты знаешь о визжащих гарпиях в небесах? Они очень противные существа, называющие себя серафимами, КОТОРЫЕ ПРОСТО НЕ МОГУТ ЗАТКНУТЬСЯ! У них есть лидер в небесном дворце на востоке, может, если ты ее проучишь, то они заткнут свои рты!";
                        case "downedRajahY":
                        return "Ты победил Раджу?! Пффт, ага, конечно. Я видел, как он наказывал мнимых богов. Невозможно!";
                        case "downedRajahN":
                        return "Ты видел этих кроликов, прыгающих вокруг? Я... ну... я бы их не трогал на твоем месте. Есть легенда о 'Защитнике', который их оберегает от угроз нашего мира. Почему легенда? Потому что нет существа, которое с ним сражалось и выжило. Неплохая история, а? ";
                        case "downedGreedYBookY":
                        ...
                        case "downedGreedN":
                        return "Эй, ем, под землей есть огромная куча сокровищ, но она охраняется скупым червем. Ты должен пойти и проверить это место на наличие этих самых сокровищ, но... ем, там есть кое-что мое. Можешь сбегать туда  и забрать это для меня? Не волнуйся, когда ты увидишь, то сразу поймешь, что это мое. ";
                        case "downedAthenaAY":
                        return "Хм? Кто такой Вариан спрашиваешь? Я этого слова годами не слышал... так давно, что еле помню имя. Хотя я припоминаю что-то про одного вариана, который где-то здесь.";
                        case "downedAthenaAN":
                        ...
                        case "GreedACalamityMod":
                        return "Знаешь, твое сражение с Пожирателем Богов напомнило мне Жадность немного... Я имею ввиду, подумай. У них обоих есть возможность создавать червоточины, и они оба адаптируются к тому, что они едят. Могут ли они быть... не, это бред...или..?";
                        case "downedGreedAY":
                        return "Так все это время он скрывал свою истинную силу. Интересно почему... может ли он от кого-то скрываться..?";
                        case "downedGreedAN":
                        ...
                        case "downedSistersY":
                        return "Хорошо ты преподал этим двум крысам урок! Такого они не ожидали!";
                        case "downedSistersN":
                        ...
                        case "downedZeroY":
                        return "…Буду честен. Мне не нравится, что эта штука сказала после смерти... ";
                        case "downedZeroN":
                        return "Бывал в Пустоте? Ну, летающие жуткие острова на востоке? Там есть БОЛЬШАЯ страшная машина, которая всегда там просто летает! В любом случае, после того как ты пришлепнул Лунного Лорда, я почувствовал массивную шоковую волну из Пустоты. Можешь сходить туда и проверить, хотя бы для меня? ";
                        case "downedShenY":
                        return "БОЖЕ-- Я знал, что в тебе что-то есть! Потрясающе! Хотя... он был очень зол, когда ты победил его... такой же злой, как когда его победила--ехм, забудь.  ";
                        case "downedShenN":
                        return "Акума и Ямата... знаешь ли, эти двое когда-то были одним целым. И боже, этот парень был силен. Он стер с лица Террарии 2 цивилизации. В любом случае, ты что-то хотел? ";
                        case "downedRajahCY":
                        return "Так старый добрый Раджа отдал свой скипетр? Похоже, что он считает тебя идеальным выбором для следующего защитника. Я бы, наверное, так же поступил на его месте. Он сделал все правильно.";
                        case "downedRajahCN":
                        ...
                        case "AkumaGuideChat":
                        return "На твоем месте, я бы не приходил в Трясину днем. Там становится очень туманно и ничего не видно. Хотя.. Я думаю, что ты можешь сделать фонарь из когтей пламени. Он может помочь. ";
                        case "YamataGuideChat":
                        return "По какой-то причине, Вулкан в Инферно становится активным ночью. Может быть, ты сможешь пройти там, если сделаешь подобие прикрытия из когтей гидры. Их пепел не обжигает.";
                        case "JungleGuideChat":
                        ...
                        case "HydraGuideChat":
                        return "Под озером, в трясине, есть коконы... чего-то. Даже знать не хочу, что эта Гидра ест. Но я не ломал бы их. Эта ящерица очень раздражается, когда кто-то трогает ее еду. ";
                        case "VoidGuideChat":
                        return "Летающие острова на востоке пугают меня. Они... просто есть. Мне кажется, что там какие-то дома, но подыматься туда я точно не собираюсь.  ";
                        case "HardModeGuideChat1":
                        return "Эй, если ты спустишься в пещеры биомов хаоса, то можешь достать души, по типу тех, которые можно собрать в биомах зла. ";
                        case "HardModeGuideChat2":
                        return "Эй, встречал лягушек в трясине? Я слышал, что в них накоплена куча монет. Так что идешь туда, бьеш их немного и БУМ! Деньжата! ";
                        case "PlantBossGuideChat":
                        return "Ты слышал музыку, идущую из Террариума? Мне кажется, что там появилось что-то новенкое. Посмотрим, сможешь ли ты достать их зеленые призмы. Думаю, что из них ты можешь сделать новую крутую крафтинговую станцию. ";
                        case "EquinoxBossGuideChat":
                        return "Видел эти светящиеся сферы в атмосфере? Если я точно помню, то они меняются в зависимости от времени суток. Может ты получишь с них что-то новое, если вскопаешь их в другое время суток? ";
                        case "AnubisChatMask":
						...
						*чешет себя*";
                        ...
                        case "AnubisChat19":
                        return "и она была со мной так добра. Это... странно... учитывая, что тогда была кровавая луна... ";
                        case "AnubisChat20":
                        return "Эй, неплохой костюмчик! ";
                        case "AnubisChat21":
                        return "Эй, нравиться моя летающая праздничная шапка? Магия бывает прикольной. ";
                        case "AnubisChat22":
                        ...
                        case "AnubisChat32":
                        return "... И затем он перевернул все, и оказалось, что он превратил себя в огурец. Самая смешная херня, которую я видел. Хах? С кем я говорю? Без понятия.";
                    }
                }
            else
                {
            ...
            if(Language.ActiveCulture == GameCulture.Chinese)
            ...
            else if(Language.ActiveCulture == GameCulture.Russian)
                {
                    switch(BossInfo)
                    {
                        ...
                        case "AnubisTransition6":
                        return "Мне надо быть уверенным, что ты готов... потому что если ты не готов...";
                        case "AnubisTransition7":
                        ...
                        case "SeraphHerald4":
                        return "Я бы пожелала, что бы ты ноги себе обломал, но мы сами их обломаем, как только ты явишься!";
                        case "SeraphHerald5":
...
现在这个数字非常大，你并不清楚它意味着什么.";
            ...
            else if(Language.ActiveCulture == GameCulture.Russian)
                {
                    switch(Tiles)
                    {
                        ...
                        case "DoomClockGetTime1":
                        return @"Часы ведут отчет до чего-то... Но вы не знаете чего.
На данный момент число настолько большое, что вы даже не знаете как оно читается";
                        case "DoomClockGetTime2":
                        ...
                        case "TerraStatueInfo": 
                        return "Герой, спасший нас всех от хаоса"; 
                        ...
                        case "HydraPod1":
                        return "Все содержимое разливается из кокона. Мерзость.";
                        case "HydraPod2":
                        return "Вы слышите шипение вдалеке...";
                        case "HydraPod3":
                        return "Вы слышите шипение, но оно затихает в тумане";
                    }
                }
            else
                {
