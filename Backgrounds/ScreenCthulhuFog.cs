...
namespace AAMod.Backgrounds
{
    public class ScreenCthulhuFog
    {
        ...
        public void Update(Texture2D texture)
        {
            ...
            bool CthulhuTime = Main.player[Main.myPlayer].InZone("Ocean") && AAWorld.downedAllAncients && !AAWorld.downedSoC;
            if (!backgroundFog && (BasePlayer.HasAccessory(player, AAMod.instance.ItemType("Lantern"), true, false) || AAWorld.downedSoC)) CthulhuTime = false;
