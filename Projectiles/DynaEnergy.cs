    ...
    class DynaEnergy : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int num572 = 0; num572 < 5; num572++)
            {
                ...
                int num575 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadO>(), 0f, 0f, 100, default, 1.3f);
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadO>(), 0f, 0f, 100, Color.White, 1.6f);
            ...
            for (int m = 0; m < pieCut; m++)
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadO>(), 0f, 0f, 100, Color.White, 2f);
