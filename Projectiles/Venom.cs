    ...
    public class Venom : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			for (int num151 = 0; num151 < 3; num151++)
			{
				...
				int num154 = 14;
				int num155 = Dust.NewDust(new Vector2(projectile.position.X + num154, projectile.position.Y + num154), projectile.width - num154 * 2, projectile.height - num154 * 2, mod.DustType<Dusts.AcidDust>(), 0f, 0f, 100, default(Color), 1f);
