...
namespace AAMod.Projectiles
{
    public class ChaosJavelinEX : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int Proj = Projectile.NewProjectile(projectile.position, Vector2.Zero, Terraria.ModLoader.ModContent.ProjectileType<ChaosBoomEX>(), projectile.damage, projectile.knockBack, Main.myPlayer, Main.rand.Next(2), 1);
