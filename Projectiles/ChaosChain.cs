    ...
    public class ChaosChain : ModProjectile
    {
		...
		public override void AI()
		{
            if (Main.rand.NextFloat() < 1f)
            {
                ...
                dust1 = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0, 0, 0)];
                dust2 = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.YamataAuraDust>(), 0, 0, 0)];
		...
		{
            target.AddBuff(Terraria.ModLoader.ModContent.BuffType<Buffs.HydraToxin>(), 150);
            target.AddBuff(Terraria.ModLoader.ModContent.BuffType<Buffs.DragonFire>(), 150);
        }
