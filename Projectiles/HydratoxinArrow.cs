...
namespace AAMod.Projectiles
{
    public class HydratoxinArrow : ModProjectile
	{
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                num468 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, mod.DustType<Dusts.AbyssiumDust>(), -projectile.velocity.X * 0.2f,
