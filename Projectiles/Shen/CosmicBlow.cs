...
namespace AAMod.Projectiles.Shen
{
    public class CosmicBlow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), 0f, 0f, 200, default, 3.7f);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), 0f, 0f, 0, default, 2.7f);
