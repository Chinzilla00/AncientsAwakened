...
namespace AAMod.Projectiles.Shen
{
    public class MeteorRed : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (EnemyHit)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("MeteorBoomRed"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
            }
        }
