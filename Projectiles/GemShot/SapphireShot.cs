...
namespace AAMod.Projectiles.GemShot
{
    class SapphireShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust1;
                dust1 = Main.dust[Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, ModContent.DustType<Dusts.AbyssDust>(), 0, 0, 0, Color.Blue, 1f)];
