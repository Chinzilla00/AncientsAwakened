		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				for (int num627 = 0; num627 < num626; num627 = num3 + 1)
				{
					...
					num628 *= 10f;
					num629 *= 10f;
					int p = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, num628, num629, Terraria.ModLoader.ModContent.ProjectileType<CursedFireball>(), projectile.damage*3, (int)(projectile.knockBack * 0.35), Main.myPlayer, 0f, 0f);
					num3 = num627;
