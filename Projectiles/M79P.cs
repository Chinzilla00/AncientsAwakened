    ...
    public class M79P : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int num733 = 0; num733 < 2; num733 = num3 + 1)
			{
				...
				int num734 = Gore.NewGore(new Vector2(projectile.position.X, projectile.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
				...
				num734 = Gore.NewGore(new Vector2(projectile.position.X, projectile.position.Y), default(Vector2), Main.rand.Next(61, 64), 1f);
