...
namespace AAMod.Projectiles
{
    public class ChaosScythe : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), 0, 0, Terraria.ModLoader.ModContent.DustType<Dusts.AbyssDust>(), 0f, 0f, 0, AAColor.Jevil, 1f);
