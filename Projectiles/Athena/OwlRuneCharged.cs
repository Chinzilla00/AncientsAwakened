        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] % 30f == 0f && projectile.ai[0] < 180f && Main.netMode != 1)
            {
                ...
                for (int num842 = 0; num842 < num838; num842++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector83.X, vector83.Y, mod.ProjectileType<AthenaShockF>(), projectile.damage, 0f, Main.myPlayer, vector82.ToRotation(), ai);
                }
            }
