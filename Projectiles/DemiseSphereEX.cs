...
namespace AAMod.Projectiles
{
    public class DemiseSphereEX : ModProjectile
	{
        ...
        public override void Kill(int timeleft)
        {
            ...
            int p = Projectile.NewProjectile((int)projectile.Center.X, (int)projectile.Center.Y, 0, 0, Terraria.ModLoader.ModContent.ProjectileType<DemiseBlast>(), projectile.damage, projectile.knockBack, Main.myPlayer);
