    ...
    public class SThunderBullet : ModProjectile
	{
        ...
        public void DropMeteor()
        {
            ...
            for (int num113 = 0; num113 < num112; num113++)
            {
                ...
                Projectile.NewProjectile(vector2.X, vector2.Y, num114 * 0.75f, num115 * 0.75f, Terraria.ModLoader.ModContent.ProjectileType<TLThunder>(), projectile.damage, projectile.damage, player.whoAmI, 0f, 0.5f + ((float)Main.rand.NextDouble() * 2f));
            }
        }
    }
}