    ...
    public class AMR : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (projectile.ai[1] == 1f && projectile.ai[0] != 1f)
			{
				...
				for (int i = 0; i < 3; i++)
				{
					int num5 = Dust.NewDust(value - Vector2.One * 8f, 16, 16, Terraria.ModLoader.ModContent.DustType<Dusts.VoidDust>(), projectile.velocity.X / 2f, projectile.velocity.Y / 2f, 100);
