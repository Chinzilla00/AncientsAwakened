...
{
    public class Gigataser : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (projectile.ai[1] == 1f && projectile.ai[0] != 1f)
			{
				...
				vector2 = vector2.RotatedBy(projectile.rotation - 1.57079637f);
				Vector2 value = projectile.Center + vector2;
				for (int i = 0; i < 3; i++)
				{
					int num5 = Dust.NewDust(value - Vector2.One * 8f, 16, 16, mod.DustType<Dusts.VoidDust>(), projectile.velocity.X / 2f, projectile.velocity.Y / 2f, 100);
