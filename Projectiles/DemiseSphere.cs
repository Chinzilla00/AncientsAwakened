...
namespace AAMod.Projectiles
{
    public class DemiseSphere : ModProjectile
	{
        ...
        public override void Kill(int timeleft)
        {
            ...
            int p = Projectile.NewProjectile((int)projectile.Center.X, (int)projectile.Center.Y, 0, 0, Terraria.ModLoader.ModContent.ProjectileType<DemiseBoom>(), projectile.damage, projectile.knockBack, Main.myPlayer);
