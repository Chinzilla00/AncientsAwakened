...
namespace AAMod.Projectiles.Akuma.Dawnstrike
{
    public class FireshotF : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dustId3 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height + 5, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), projectile.velocity.X * 0.2f,
                projectile.velocity.Y * 0.2f, 100, default, 2f);
