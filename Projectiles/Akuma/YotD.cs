...
namespace AAMod.Projectiles.Akuma
{
    public class YotD : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (float num656 = 0f; num656 < num653; num656 += 1f)
            {
                for (int num657 = 0; num657 < 2; num657++)
                {
                    ...
                    for (float num658 = 0f; num658 < num655; num658 += 1f)
                    {
                        ...
                        int num659 = Dust.NewDust(projectile.Center, 6, 6, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 100, default, 1.3f);
            ...
            for (float num660 = 0f; num660 < num653; num660 += 1f)
            {
                for (int num661 = 0; num661 < 2; num661++)
                {
                    ...
                    for (float num662 = 0f; num662 < num655; num662 += 1f)
                    {
                        ...
                        int num663 = Dust.NewDust(projectile.Center, 6, 6, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 100, default, 1.3f);
            ...
            {
                float num665 = num654;
                int num667 = Dust.NewDust(projectile.Center, 6, 6, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), 0f, 0f, 100);
