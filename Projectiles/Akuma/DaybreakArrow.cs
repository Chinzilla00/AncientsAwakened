...
namespace AAMod.Projectiles.Akuma
{
    public class DaybreakArrow : ModProjectile
	{
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                num468 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), -projectile.velocity.X * 0.2f,
