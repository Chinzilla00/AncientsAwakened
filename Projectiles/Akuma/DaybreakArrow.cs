...
namespace AAMod.Projectiles.Akuma
{
    public class DaybreakArrow : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("FireProjBoom"), projectile.damage / 3, projectile.knockBack, projectile.owner, 0f, 0f);
