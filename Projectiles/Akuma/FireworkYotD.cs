        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] == 1f)
            {
                ...
                if (projectile.ai[0] == 1f)
                {
                    ...
                    {
                        int num353 = Dust.NewDust(projectile.position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 100, default, 1.8f);
                ...
                {
                    int num354 = Dust.NewDust(new Vector2(projectile.position.X + 2f, projectile.position.Y + 20f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), projectile.velocity.X, projectile.velocity.Y, 100, default, 1.2f);
                    ...
                    num354 = Dust.NewDust(new Vector2(projectile.position.X + 2f, projectile.position.Y + 15f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), projectile.velocity.X, projectile.velocity.Y, 100, default, 1.2f);
                    Main.dust[num354].noGravity = true;
                    Main.dust[num354].velocity *= 0.2f;
                    Main.dust[num354].position = Main.dust[num354].position.RotatedBy(projectile.rotation, projectile.Center);
                    num354 = Dust.NewDust(new Vector2(projectile.position.X + 2f, projectile.position.Y + 10f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), projectile.velocity.X, projectile.velocity.Y, 100, default, 1.2f);
                    Main.dust[num354].noGravity = true;
                    Main.dust[num354].velocity *= 0.2f;
                    Main.dust[num354].position = Main.dust[num354].position.RotatedBy(projectile.rotation, projectile.Center);
                    return;
            ...
            else
            {
                ...
                {
                    int num356 = Dust.NewDust(new Vector2(projectile.position.X + 2f, projectile.position.Y + 20f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), projectile.velocity.X, projectile.velocity.Y, 100, default, 1.2f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (ExplosionType == 0)
            {
                for (int num639 = 0; num639 < 400; num639++)
                {
                    ...
                    int num642 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), 6, 6, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>(), 0f, 0f, 100);
            ...
            else if (ExplosionType == 1)
            {
                for (int num646 = 0; num646 < 400; num646++)
                {
                    ...
                    int num649 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), 6, 6, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 100);
            ...
            else if (ExplosionType == 2)
            {
                ...
                {
                    int num672 = Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>();
                    float num673 = 16f;
                    if (num671 > 100)
                    {
                        num673 = 11f;
                    ...
                    if (num671 > 100)
                    {
                        num672 = Terraria.ModLoader.ModContent.DustType<Dusts.AkumaADust>();
                    }
                    if (num671 > 200)
                    {
                        num673 = 8f;
                    ...
                    if (num671 > 200)
                    {
                        num672 = Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>();
                    }
                    if (num671 > 300)
                    {
                        num673 = 5f;
