...
namespace AAMod.Projectiles
{
    public class ChaosArrow : ModProjectile
	{
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                num468 = Dust.NewDust(new Microsoft.Xna.Framework.Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, Main.rand.Next(2) == 0 ? mod.DustType<Dusts.IncineriteDust>() : mod.DustType<Dusts.AbyssiumDust>(), -projectile.velocity.X * 0.2f,
