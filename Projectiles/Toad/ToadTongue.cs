    ...
    public class ToadTongue : ModProjectile
    {
		...
		public override void AI()
		{
            if (Main.rand.NextFloat() < 1f)
            {
                ...
                dust1 = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.ShroomDust>(), 0, 0, 0, default, 1f)];
                dust2 = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.ShroomDust>(), 0, 0, 0, default, 1f)];
