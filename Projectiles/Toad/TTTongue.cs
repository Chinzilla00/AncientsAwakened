...
{
    public class TTTongue : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TTTongue");
        }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.velocity = Vector2.Normalize(target.Center - player.Center) * 16f;
        }

        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {

            Texture2D texture = ModLoader.GetTexture("AAMod/Projectiles/Toad/TTTongue_Chain");
