...
namespace AAMod.Projectiles
{
    public class GameRocket : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadR>(), 0f, 0f, 100, Color.White, 1.6f);
            ...
            for (int m = 0; m < pieCut; m++)
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2, Terraria.ModLoader.ModContent.DustType<Dusts.InfinityOverloadR>(), 0f, 0f, 100, Color.White, 2f);
