    ...
    public class DarkSoul : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num572 = 0; num572 < 5; num572++)
            {
                ...
                int num575 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.YamataDustLight>(), 0f, 0f, 100, default, 1.3f);
