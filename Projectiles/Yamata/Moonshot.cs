    ...
    public class Moonshot : ModProjectile
    {
            ...
            if (projectile.alpha > 0)
            {
                ...
                if (projectile.alpha < 0)
                {
                    ...
                    while ((float)num110 < num109)
                    {
                        ...
                        int num111 = Dust.NewDust(projectile.Center, 0, 0, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 0, default(Color), 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num87 = 0; num87 < 20; num87++)
            {
                ...
                num88 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 100, default(Color), 1.5f);
                Main.dust[num88].position = projectile.Center + (Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * (float)num84 / 2f);
            ...
            {
                int num92 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 0, default(Color), 1.5f);
