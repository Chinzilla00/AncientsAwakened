...
namespace AAMod.Projectiles.Yamata
{
    class Masamune : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num137 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.YamataDust>(), 0f, 0f, 0, default, 1f);
            ...
            if (projectile.localAI[1] > 10f && Main.rand.Next(3) == 0)
            {
                ...
                for (int num694 = 0; num694 < num693; num694++)
                {
                    ...
                    int num695 = Dust.NewDust(vector56 + value24, 0, 0, Terraria.ModLoader.ModContent.DustType<Dusts.YamataDust>(), value24.X * 2f, value24.Y * 2f, 100, default, 1.4f);
