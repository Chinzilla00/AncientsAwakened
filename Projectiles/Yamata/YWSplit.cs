...
namespace AAMod.Projectiles.Yamata
{
    public class YWSplit : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num557 = 8;
            //dust!
            int dustId = Dust.NewDust(new Vector2(projectile.position.X + num557, projectile.position.Y + num557), projectile.width - num557 * 2, projectile.height - num557 * 2, mod.DustType<Dusts.YamataADust>(), 0f, 0f, 0);
            Main.dust[dustId].noGravity = true;
            int dustId3 = Dust.NewDust(new Vector2(projectile.position.X + num557, projectile.position.Y + num557), projectile.width - num557 * 2, projectile.height - num557 * 2, mod.DustType<Dusts.YamataADust>(), 0f, 0f, 0);
