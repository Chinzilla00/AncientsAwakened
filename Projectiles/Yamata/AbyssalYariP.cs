...
namespace AAMod.Projectiles.Yamata
{
    public class AbyssalYariP : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
        {
            ...
            velocityX *= num6;
            velocityY *= num6;
            Projectile p = Projectile.NewProjectileDirect(new Vector2(screenX, screenY), new Vector2(velocityX, velocityY), mod.ProjectileType<Moonblow>(), damage, 0f, player.whoAmI);
            p.tileCollide = false;
        }
    }
}
