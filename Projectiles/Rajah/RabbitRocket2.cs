            ...
            else
            {
                ...
                if (projectile.ai[0] > 30f)
                {
                    ...
                    for (int num238 = 0; num238 < 200; num238++)
                    {
                        ...
                        {
                            float num239 = Main.npc[num238].position.X + (Main.npc[num238].width / 2);
                            float num240 = Main.npc[num238].position.Y + (Main.npc[num238].height / 2);
                            ...
                            if (num241 < num237 && Collision.CanHit(projectile.position, projectile.width, projectile.height, Main.npc[num238].position, Main.npc[num238].width, Main.npc[num238].height))
                            {
                                num237 = num241;
                                num235 = num239;
                                num236 = num240;
