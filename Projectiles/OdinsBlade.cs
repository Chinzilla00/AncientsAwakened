...
namespace AAMod.Projectiles
{
    class OdinsBlade : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num309 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X * 4f + 2f, projectile.position.Y + 2f - projectile.velocity.Y * 4f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.SnowDustLight>(), projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default, 1.25f);
                Main.dust[num309].velocity *= -0.25f;
                num309 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X * 4f + 2f, projectile.position.Y + 2f - projectile.velocity.Y * 4f), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.SnowDustLight>(), projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default, 1.25f);
                Main.dust[num309].velocity *= -0.25f;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num794 = 4; num794 < 31; num794++)
            {
                ...
                int num797 = Dust.NewDust(new Vector2(projectile.oldPosition.X - num795, projectile.oldPosition.Y - num796), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.SnowDustLight>(), projectile.oldVelocity.X, projectile.oldVelocity.Y, 27, default, 1.8f);
                Main.dust[num797].noGravity = true;
                Main.dust[num797].velocity *= 0.5f;
                num797 = Dust.NewDust(new Vector2(projectile.oldPosition.X - num795, projectile.oldPosition.Y - num796), 8, 8, Terraria.ModLoader.ModContent.DustType<Dusts.SnowDustLight>(), projectile.oldVelocity.X, projectile.oldVelocity.Y, 27, default, 1.4f);
