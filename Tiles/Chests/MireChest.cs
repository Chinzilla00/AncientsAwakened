...
namespace AAMod.Tiles.Chests
{
    public class MireChest : ModTile
	{
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Locked Mire Chest");
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 32, mod.ItemType("MireChest"));
		...
		public override void RightClick(int i, int j)
		{
            ...
            else
            {
                if (isLocked)
                {
                    int key = Terraria.ModLoader.ModContent.ItemType<Items.Usable.MireKey>();
            ...
            else
            {
                ...
                if (player.showItemIconText == "Mire Chest")
                {
                    ...
                    if (Main.tile[left, top].frameX / 36 == 1)
                        player.showItemIcon2 = Terraria.ModLoader.ModContent.ItemType<Items.Usable.MireKey>();
