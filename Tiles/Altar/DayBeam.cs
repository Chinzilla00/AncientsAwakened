...
namespace AAMod.Tiles.Altar
{
    public class DayBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.npc[(int)projectile.ai[1]].active && Main.npc[(int)projectile.ai[1]].modNPC is WormBeaconDay)
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = mod.GetTexture("Tiles/Altar/DayBeam2");
            Texture2D texture2D21 = mod.GetTexture("Tiles/Altar/DayBeam3");
    ...
    public class NightBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.npc[(int)projectile.ai[1]].active && Main.npc[(int)projectile.ai[1]].modNPC is WormBeaconNight)
            {
                projectile.Center = Main.npc[(int)projectile.ai[1]].Center;
                if (projectile.ai[0] == 0)
                {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D19 = Main.projectileTexture[projectile.type];
            Texture2D texture2D20 = mod.GetTexture("Tiles/Altar/NightBeam2");
            Texture2D texture2D21 = mod.GetTexture("Tiles/Altar/NightBeam3");
            float num223 = projectile.localAI[1];
            Color color44 = new Color(255, 255, 255, 0) * 0.9f;
            SpriteBatch arg_ABD8_0 = Main.spriteBatch;
            Texture2D arg_ABD8_1 = texture2D19;
