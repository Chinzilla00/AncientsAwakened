...
namespace AAMod.Tiles.Furniture.Razewood
{
    public class RazewoodChest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chest = "Razewood Chest";
            chestDrop = mod.ItemType("RazewoodChest");
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Razewood Chest";
                if (player.showItemIconText == "Razewood Chest")
                {
                    player.showItemIcon2 = mod.ItemType("RazewoodChest");
