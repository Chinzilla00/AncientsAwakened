...
{
    public class FlamebruteProjectileGore5 : ModProjectile
    {
        ...
        public void TheStrideGore()
        {
            ...
            Gore.NewGore(projectile.position, new Vector2(Main.rand.NextFloat(-20, 20), Main.rand.NextFloat(0, -40)), mod.GetGoreSlot("Gores/FlamebruteGore5"), 1f);
            Gore.NewGore(projectile.position, new Vector2(Main.rand.NextFloat(-20, 20), Main.rand.NextFloat(0, -40)), mod.GetGoreSlot("Gores/FlamebruteGore6"), 1f);
        }
