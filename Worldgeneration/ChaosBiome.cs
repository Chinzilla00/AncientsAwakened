...
namespace AAMod.Worldgeneration
{
    ...
    public class Equinox : MicroBiome
    {
        public override bool Place(Point origin, StructureMap structures)
        {
            ...
            WorldGen.PlaceObject(origin.X + 27, origin.Y + 26, mod.TileType("EnderMemory"));
            NetMessage.SendObjectPlacment(-1, origin.X + 27, origin.Y + 26, mod.TileType("EnderMemory"), 0, 0, -1, -1);
