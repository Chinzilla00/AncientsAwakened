...
{
	public class OrthrusShock : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            Lighting.AddLight(projectile.Center, 0.45f, 0.2f, 0.5f);
            if (projectile.velocity == Vector2.Zero)
            {
                ...
                if (Main.rand.Next(projectile.extraUpdates) == 0)
                {
                    for (int num850 = 0; num850 < 2; num850++)
                    {
                        ...
                        int num853 = Dust.NewDust(projectile.Center, 0, 0, mod.DustType<Dusts.FulguriteDust>(), vector84.X, vector84.Y, 0, default(Color), 1f);
                    ...
                    if (Main.rand.Next(5) == 0)
                    {
                        ...
                        int num854 = Dust.NewDust(projectile.Center + value49 - Vector2.One * 4f, 8, 8, mod.DustType<Dusts.FulguriteDust>(), 0f, 0f, 100, default(Color), 1.5f);
