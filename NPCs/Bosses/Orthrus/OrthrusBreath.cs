...
{
    internal class OrthrusBreath : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] > 7f)
            {
                ...
                if (Main.rand.Next(2) == 0)
                {
                    ...
                    {
                        int num299 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, mod.DustType("FulguriteDust"), projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100);
