...
namespace AAMod.NPCs.Bosses.Akuma.Awakened
{
    public class SunA : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            BaseAI.ShootPeriodic(npc, player.position, player.width, player.height, Terraria.ModLoader.ModContent.ProjectileType<AkumaRock>(), ref npc.ai[1], 100, npc.damage / 4, 11, true);
        }
    }
}
