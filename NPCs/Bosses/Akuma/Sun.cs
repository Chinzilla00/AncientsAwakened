...
namespace AAMod.NPCs.Bosses.Akuma
{
    public class Sun : ModNPC
	{
        ...
        {
            DisplayName.SetDefault("Draconian Sun");
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            BaseDrawing.DrawTexture(spriteBatch, mod.GetTexture("NPCs/Bosses/Akuma/Sun1"), 0, npc.position + new Vector2(0, npc.gfxOffY), npc.width, npc.height, npc.scale, -npc.rotation, npc.spriteDirection, 1, SunFrame, npc.GetAlpha(AAColor.COLOR_WHITEFADE1), true);
            BaseDrawing.DrawTexture(spriteBatch, mod.GetTexture("NPCs/Bosses/Akuma/Sun"), 0, npc.position + new Vector2(0, npc.gfxOffY), npc.width, npc.height, npc.scale, npc.rotation, npc.spriteDirection, 1, SunFrame, npc.GetAlpha(AAColor.COLOR_WHITEFADE1), true);
            return false;
        }
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0]++ > 450 && Main.netMode != 1)
            {
                ...
                {
                    int num90 = Dust.NewDust(position, num84, height3, Terraria.ModLoader.ModContent.DustType<Dusts.AbyssDust>(), 0f, 0f, 0, default, 2.7f);
                ...
                {
                    int num92 = Dust.NewDust(position, num84, height3, Terraria.ModLoader.ModContent.DustType<Dusts.YamataDust>(), 0f, 0f, 0, default, 1.5f);
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust31 = Main.dust[Dust.NewDust(npc.Center - vector135 * 30f, 0, 0, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 0, default, 1f)];
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust32 = Main.dust[Dust.NewDust(npc.Center - vector136 * 30f, 0, 0, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), 0f, 0f, 0, default, 1f)];
            ...
            if (npc.ai[0] < 0f)
            {
                ...
                int num1059 = Dust.NewDust(center15 - Vector2.One * 8f, 16, 16, Terraria.ModLoader.ModContent.DustType<Dusts.AkumaDust>(), npc.velocity.X / 2f, npc.velocity.Y / 2f, 0);
            ...
            BaseAI.ShootPeriodic(npc, player.position, player.width, player.height, Terraria.ModLoader.ModContent.ProjectileType<Flameburst>(), ref npc.ai[1], 60, npc.damage / 4, 11, true);
        }
    }
}
