    ...
    public class Akuma : ModNPC
    {
        ...
        public override bool PreAI()
        {
            ...
            if (fireAttack == true)
            {
                ...
                {
                    AAAI.BreatheFire(npc, true, Terraria.ModLoader.ModContent.ProjectileType<AkumaBreath>(), 2, 4);
                }
                if (attackTimer >= 80)
                {
                    fireAttack = false;
        ...
        public void Attack(NPC npc)
        {
            ...
            else if (internalAI[1] == 2)
            {
                ...
                if (internalAI[0] == 350)
                {
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, npc.velocity.X * 2, npc.velocity.Y, Terraria.ModLoader.ModContent.ProjectileType<AkumaFireProj>(), damage, 3, Main.myPlayer);
                }
            }
            else if (internalAI[1] == 3)
            {
                ...
                if (internalAI[0] == 350)
                {
                    for (int a = 0; a < 2; a++)
                    {
                        NPC.NewNPC((int)(player.position.X + Main.rand.Next(400)), (int)(player.position.Y + Main.rand.Next(400)), Terraria.ModLoader.ModContent.NPCType<Sun>());
                    }
                }
            }
            else
            {
                ...
                if (internalAI[0] == 350)
                {
                    ...
                    for (int i = 0; i < Fireballs; i++)
                    {
                        ...
                        Projectile.NewProjectile(npc.Center.X, npc.Center.Y, baseSpeed * (float)Math.Sin(offsetAngle) * 2, baseSpeed * (float)Math.Cos(offsetAngle) * 2, Terraria.ModLoader.ModContent.ProjectileType<AkumaBomb>(), damage, 3, Main.myPlayer);
                    }
                }
            }
        }
