    ...
    public class ShenSpawn : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] == 900)
            {
                ...
                //if (Main.netMode != 1) BaseUtility.Chat(Lang.BossChat("ShenSpawn5"), new Color(45, 46, 70)); duplicated fsr
            }
    ...
    public class ShenTransition : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                if (npc.ai[0] == 375)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition1"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] == 475)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition2"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] == 600)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition3"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] == 820)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition4"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] == 960)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition5"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] >= 1100)
                {
                ...
                if (npc.ai[0] == 1100)
                {
                    BaseUtility.Chat(Lang.BossChat("ShenTransition6"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                    npc.netUpdate = true;
                }
                if (npc.ai[0] >= 1400)
                {
        ...
        public void SummonShen()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                BaseUtility.Chat(Lang.BossChat("ShenTransition7"), Color.Magenta.R, Color.Magenta.G, Color.Magenta.B);
                BaseUtility.Chat(Lang.BossChat("ShenTransition8"), Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
            }
