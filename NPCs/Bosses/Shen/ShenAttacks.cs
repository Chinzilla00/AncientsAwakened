...
namespace AAMod
{
    public class ShenAttacks
	{
        ...
        public static void Eruption(NPC npc, Mod mod)
        {
            ...
            Projectile.NewProjectile(vector2.X, vector2.Y, 0, num115 * 1.5f, mod.ProjectileType("ShenMeteor1"), (int)(npc.damage / 1.3f), 0, player.whoAmI, 0f, 0.5f + ((float)Main.rand.NextDouble() * 0.3f));
        }
    }
}