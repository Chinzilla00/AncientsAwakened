    ...
    public class ShenAttacks
	{
        ...
        public static void Thunderstrike(NPC npc, Mod mod)
        {
            ...
            for (int num120 = 0; num120 < 3; num120++)
            {
                ...
                int L = Projectile.NewProjectile(vector2.X, vector2.Y, speedX5, speedY5, mod.ProjectileType<NPCs.Bosses.Shen.ChaosLightning>(), npc.damage / 2, 1, player.whoAmI, vector13.ToRotation());
