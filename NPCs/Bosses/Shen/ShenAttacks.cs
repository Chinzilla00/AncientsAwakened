    ...
    public class ShenAttacks
	{
        ...
        public static void Dragonfire(NPC npc, Mod mod)
        {
            ...
            for (int num120 = 0; num120 < 3; num120++)
            {
                ...
                Projectile.NewProjectile(vector2.X, vector2.Y, speedX5, speedY6, mod.ProjectileType<NPCs.Bosses.Shen.DiscordianInferno>(), npc.damage, 6, Main.myPlayer);
            }
        }
        ...
        public static void Eruption(NPC npc, Mod mod)
        {
            ...
            Projectile.NewProjectile(vector2.X, vector2.Y, 0, num115 * 1.25f, mod.ProjectileType("ShenMeteor1"), (int)(npc.damage / 1.3f), 0, player.whoAmI, 0f, 0.5f + ((float)Main.rand.NextDouble() * 0.3f));
        }
    }
}