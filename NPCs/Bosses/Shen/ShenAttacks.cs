        ...
        public static void Thunderstrike(NPC npc, Mod mod)
        {
            ...
            for (int num119 = 0; num119 < 3; num119++)
            {
                for (int num120 = 0; num120 < 3; num120++)
                {
                    ...
                    int L = Projectile.NewProjectile(vector2.X, vector2.Y, speedX5 * 2, speedY5 * 2, mod.ProjectileType<NPCs.Bosses.Shen.ChaosLightning>(), npc.damage / 2, 1, Main.myPlayer, vector13.ToRotation());
