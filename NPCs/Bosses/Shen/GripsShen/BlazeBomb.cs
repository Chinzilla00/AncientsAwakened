...
namespace AAMod.NPCs.Bosses.Shen.GripsShen
{
    internal class BlazeBomb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num190 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, mod.DustType<Dusts.YamataDust>(), 0f, 0f, 0);
