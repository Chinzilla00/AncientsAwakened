...
namespace AAMod.NPCs.Bosses.Shen
{
    public class ChaosBlast : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Unyielding Chaos");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int boomType = (swordType == 0 ? mod.ProjectileType<ShenBoom>() : swordType == 1 ? mod.ProjectileType<ShenBoomR>() : mod.ProjectileType<ShenBoomB>());
            int pieCut = 20;
