...
{
    [AutoloadBossHead]
    public class SAkuma : ModNPC
	{
        
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkuma"; } }
		...
		{
			DisplayName.SetDefault("Shadow of Akuma");
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0)
                {
                    ...
                    for (int i = 0; i < AkumaALength; ++i)
                    {
                        ...
                        {
                            latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaBody"), npc.whoAmI, 0, latestNPC);
                        ...
                        {
                            latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaArms"), npc.whoAmI, 0, latestNPC);
                            Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                            Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                            segment += 1;
                        }
                    ...
                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaTail"), npc.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            Texture2D attackAni = mod.GetTexture("NPCs/Bosses/Shadow/Akuma/SAkuma");
        ...
        public override void NPCLoot()
		{
            ...
            if (Main.expertMode)
            {
                Projectile.NewProjectile((new Vector2(npc.position.X, npc.position.Y)), (new Vector2(0f, 0f)), mod.ProjectileType("SAkumaTransition"), 0, 0);
            }
            npc.value = 0f;
            npc.boss = false;
		}
    ...
    public class SAkumaArms : SAkuma
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaArms"; } }
    ...
    public class SAkumaBody : SAkuma
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaBody"; } }
    ...
    public class SAkumaTail : SAkuma
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaTail"; } }
