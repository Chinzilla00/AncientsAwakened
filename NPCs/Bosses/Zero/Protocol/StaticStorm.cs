...
namespace AAMod.NPCs.Bosses.Zero.Protocol
{
    public class StaticStorm : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (internalAI[0] % 30f == 0f && internalAI[0] < 180f && Main.netMode != 1)
            {
                ...
                for (int num842 = 0; num842 < num838; num842++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector83.X, vector83.Y, mod.ProjectileType<ZeroShock>(), projectile.damage, 0f, Main.myPlayer, vector82.ToRotation(), ai);
                }
            }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(mod.BuffType<Buffs.Glitched>(), 120);
        }
