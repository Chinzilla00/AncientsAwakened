...
namespace AAMod.NPCs.Bosses.Zero.Protocol
{
    public class ZeroDeath1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                if (Main.netMode != 1) AAMod.Chat("MISSI0N FAILED. SENDING DISTRESS SIGNAL T0 H0ME BASE.", Color.Red.R, Color.Red.G, Color.Red.B);
                linesaid = true;
            }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                if (Main.netMode != 1) AAMod.Chat("SENDING...", Color.Red.R, Color.Red.G, Color.Red.B);
            }
