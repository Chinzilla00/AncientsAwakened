...
namespace AAMod.NPCs.Bosses.Zero.Protocol
{
    internal class GlitchBlast : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.position, Vector2.Zero, Terraria.ModLoader.ModContent.ProjectileType<GlitchBoom>(), projectile.damage, 2, projectile.owner);
        }
