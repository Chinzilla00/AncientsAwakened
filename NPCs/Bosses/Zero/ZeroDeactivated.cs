...
namespace AAMod.NPCs.Bosses.Zero
{
	public class ZeroDeactivated : ModNPC
	{
		...
		public override void AI()
		{
            ...
            {
                npc.Transform(Terraria.ModLoader.ModContent.NPCType<Zero>());
                return;
            }
            npc.timeLeft = 10;
			if(npc.ai[0] == 0)
    ...
    public class ZeroHandler : ModWorld
    {
        ...
        public void SpawnDeactivatedZero()
        {
			...
			if (!anyZerosExist)
			{
                int whoAmI = NPC.NewNPC((int)spawnPos.X, (int)spawnPos.Y, Terraria.ModLoader.ModContent.NPCType<ZeroDeactivated>());
                ZX = (int)spawnPos.X;
				ZY = (int)spawnPos.Y;				
