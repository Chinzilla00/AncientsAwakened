...
{
    [AutoloadBossHead]	
	public class SerpentHeadCo : ModNPC
	{
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentHeadCo"; } }
        ...
        public override void AI()
        {
            ...
            BaseMod.BaseAI.AIWorm(npc, new int[]{ mod.NPCType("SerpentHeadCo"), mod.NPCType("SerpentBodyCo"), mod.NPCType("SerpentTailCo") }, 12, 8f, 12f, 0.1f, false, false);

            bool isHead = npc.type == mod.NPCType("SerpentHeadCo");
			bool isBody = npc.type == mod.NPCType("SerpentBodyCo");			
			if(isHead)
			{
    ...
    public class SerpentBodyCo : SerpentHeadCo
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentBodyCo"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
            Main.npcFrameCount[npc.type] = 4;
    ...
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentTailCo"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
