...
{
    [AutoloadBossHead]	
	public class SerpentHeadCr : ModNPC
	{
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentHeadCr"; } }
        ...
        public override void AI()
        {
            ...
            BaseMod.BaseAI.AIWorm(npc, new int[]{ mod.NPCType("SerpentHeadCr"), mod.NPCType("SerpentBodyCr"), mod.NPCType("SerpentTailCr") }, 12, 8f, 12f, 0.1f, false, false);

            bool isHead = npc.type == mod.NPCType("SerpentHeadCr");
			bool isBody = npc.type == mod.NPCType("SerpentBodyCr");			
			if(isHead)
			{
    ...
    public class SerpentBodyCr : SerpentHeadCr
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentBodyCr"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
            Main.npcFrameCount[npc.type] = 4;
        ...
        {
            if (NPC.AnyNPCs(mod.NPCType<SerpentHeadCr>()))
            {
                return false;
            }
            return true;
    ...
    public class SerpentTailCr : SerpentHeadCo
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentTailCr"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
