...
{
    [AutoloadBossHead]	
	public class SerpentHeadM : ModNPC
	{
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentHeadM"; } }
        ...
        public override void AI()
        {
            ...
            BaseMod.BaseAI.AIWorm(npc, new int[]{ mod.NPCType("SerpentHeadM"), mod.NPCType("SerpentBodyM"), mod.NPCType("SerpentTailM") }, 12, 8f, 12f, 0.1f, false, false);

            bool isHead = npc.type == mod.NPCType("SerpentHeadM");
			bool isBody = npc.type == mod.NPCType("SerpentBodyM");			
			if(isHead)
			{
    ...
    public class SerpentBodyM : SerpentHeadM
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentBodyM"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
            Main.npcFrameCount[npc.type] = 4;
        ...
        {
            if (NPC.AnyNPCs(mod.NPCType<SerpentHeadM>()))
            {
                return false;
            }
            return true;
    ...
    public class SerpentTailM : SerpentHeadCo
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Serpent/SerpentTailM"; } }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Subzero Serpent");
