    ...
    public class HydraHead1 : Hydra
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[3] == 2)
            {
                ...
                {
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0f, 10f, mod.ProjectileType("AcidProj"), (int)(damage * .8f), 3f, Main.myPlayer);
                }
                if (varTime >= 60)
                {
                    if (Main.netMode != 1)
            ...
            Vector2 moveTo = new Vector2(Hydra.Center.X + npc.ai[1], Hydra.Center.Y - (90f + npc.ai[2])) - npc.Center;
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            if (Main.netMode != 0)
            {
                ...
                spriteBatch.Draw(mod.GetTexture("NPCs/Boss/Hydra/HydraHead1"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
                            new Rectangle(0, npc.frame.Y, 36, npc.frame.Y + 32), drawColor, npc.rotation,
                            new Vector2(36 * 0.5f, 32 * 0.5f), 1f, SpriteEffects.None, 0f);
                spriteBatch.Draw(mod.GetTexture("NPCs/Boss/Hydra/HydraHead1_Glow"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
