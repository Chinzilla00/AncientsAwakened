    ...
    public class AHDeath : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[1] == 100)          //if the timer has gotten to 7.5 seconds, this happens (60 = 1 second)
            {
                ...
                {
                    Main.NewText("You see Ashe? I told you this was a stupid idea, but YOU didn't listen...", new Color(72, 78, 117));
                }
            }
            ...
            if (npc.ai[1] == 300)
            {
                if (AAWorld.downedSisters)
                {
                    Main.NewText("Why do I keep going with you..? I should honestly just let you fight them yourself.", new Color(72, 78, 117));
                }
                else
                {
                    Main.NewText("Shut up! I thought if we ganged up on " + (player.Male ? "him" : "her") + ", we could just beat the daylights out of 'em!", new Color(102, 20, 48));
                }
            }
            ...
            if (npc.ai[1] == 500)
            {
                if (AAWorld.downedSisters)
                {
                    Main.NewText("Shut up!", new Color(102, 20, 48));
                    AAMod.AHIntro = false;
                    npc.active = false;
