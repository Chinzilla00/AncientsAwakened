...
namespace AAMod.NPCs.Bosses.AH.Ashe
{
    internal class AsheFire : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.Center - new Vector2(0, 115), new Vector2(0, 0), Terraria.ModLoader.ModContent.ProjectileType<AsheStrike>(), projectile.damage, 5);
