                ...
                if (++npc.ai[0] >= 6)
                {
                    ...
                    if (npc.frame.Y > (92 * 12))
                    {
                        ...
                        for (int num85 = 0; num85 < 3; num85++)
                        {
                            ...
                            Main.dust[num86].position = npc.Center + (Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * (float)num84 / 2f);
                        }
                        for (int num87 = 0; num87 < 15; num87++)
                        {
                            int num88 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 200, default(Color), 3.7f);
                            Main.dust[num88].position = npc.Center + (Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * (float)num84 / 2f);
                        ...
                        for (int num89 = 0; num89 < 10; num89++)
                        {
                            ...
                            Main.dust[num90].position = npc.Center + (Vector2.UnitX.RotatedByRandom(3.1415927410125732).RotatedBy((double)npc.velocity.ToRotation(), default(Vector2)) * (float)num84 / 2f);
                        ...
                        for (int num91 = 0; num91 < 30; num91++)
                        {
                            ...
                            Main.dust[num92].position = npc.Center + (Vector2.UnitX.RotatedByRandom(3.1415927410125732).RotatedBy((double)npc.velocity.ToRotation(), default(Vector2)) * (float)num84 / 2f);
