...
namespace AAMod.NPCs.Bosses.Toad
{
    public class ToadBomb : ModProjectile
	{
        ...
        {
            target.AddBuff(mod.BuffType<Buffs.Shroomed>(), 200);
        }
        ...
        public override void Kill(int timeleft)
        {
            ...
            for (int num468 = 0; num468 < 20; num468++)
            {
                ...
                num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, mod.DustType<Dusts.ShroomDust>(), -projectile.velocity.X * 0.2f,
