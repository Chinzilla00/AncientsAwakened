...
{
    class RazorbladeTsunami : ModProjectile
    {
                ...
                if (num611 < 255)
                {
                    ...
                    if (projectile.localAI[0] > 10f)
                    {
                        ...
                        for (int num613 = 0; num613 < num612; num613++)
                        {
                            ...
                            int num614 = Dust.NewDust(vector43 + value15, 0, 0, mod.DustType<Dusts.InfinityOverloadB>(), value15.X * 2f, value15.Y * 2f, 100, default(Color), 1.4f);
        ...
        public override void Kill(int timeleft)
        {
            ...
            for (int num326 = 0; num326 < num325; num326++)
            {
                ...
                int num327 = Dust.NewDust(vector8 + vector9, 0, 0, mod.DustType<Dusts.InfinityOverloadB>(), vector9.X * 2f, vector9.Y * 2f, 100, default(Color), 1.4f);
            ...
            if (projectile.owner == Main.myPlayer)
            {
                if (projectile.ai[1] < 1f)
                {
                    ...
                    int num329 = Projectile.NewProjectile(projectile.Center.X - (float)(projectile.direction * 30), projectile.Center.Y - 4f, (float)(-(float)projectile.direction) * 0.01f, 0f, mod.ProjectileType<EmperorHurricane1>(), num328, 4f, projectile.owner, 16f, 15f);
                ...
                else
                {
                    ...
                    int num335 = Projectile.NewProjectile((float)(num331 * 16 + 8), (float)(num330 * 16 - 24), 0f, 0f, mod.ProjectileType<EmperorHurricane2>(), num334, 4f, Main.myPlayer, 16f, 24f);
