                    ...
                    if (Main.netMode != 1)
                    {
                        if (npc.ai[2] == 0)
                        {
                            ...
                            if (npc.ai[0] >= 1200)
                            {
                                ...
                                AAModGlobalNPC.SpawnBoss(Main.player[npc.target], Terraria.ModLoader.ModContent.NPCType<AthenaA>(), false, npc.Center);
                        ...
                        else
                        {
                            ...
                            else if (npc.ai[0] >= 1200)
                            {
                                ...
                                AAModGlobalNPC.SpawnBoss(Main.player[npc.target], Terraria.ModLoader.ModContent.NPCType<AthenaFlee>(), false, npc.Center);
                                npc.active = false;
                                npc.netUpdate = true;
                            }
                        }
