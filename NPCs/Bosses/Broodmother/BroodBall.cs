...
namespace AAMod.NPCs.Bosses.Broodmother
{
    public class BroodBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, 1, Terraria.ModLoader.ModContent.DustType<Dusts.BroodmotherDust>(), -projectile.velocity.X * 0.2f,
                    -projectile.velocity.Y * 0.2f, 100, default, 2f);
                Main.dust[num469].noGravity = true;
                Main.dust[num469].velocity *= 2f;
                num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, Terraria.ModLoader.ModContent.DustType<Dusts.BroodmotherDust>(), -projectile.velocity.X * 0.2f,
