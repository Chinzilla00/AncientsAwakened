...
namespace AAMod.NPCs.Bosses.Sagittarius
{
    public class SagittariusOrbiter : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            if (!NPC.AnyNPCs(Terraria.ModLoader.ModContent.NPCType<Sagittarius>()))
            {
                npc.life = 0;
            }
        ...
        public override void NPCLoot()
        {
            if (NPC.AnyNPCs(Terraria.ModLoader.ModContent.NPCType<Sagittarius>()))
            {
                Item.NewItem(npc.Center, Terraria.ModLoader.ModContent.ItemType<Items.Materials.Doomite>(), Main.rand.Next(2));
            }
        }
