...
namespace AAMod.NPCs.Bosses.Kraken
{
    public class Tentacle1 : ModNPC
    {
		...
		public int distFromBodyX = 50; 
		public int distFromBodyY = 50;
        ...
        public override void AI()
        {
            ...
            if (Body == null)
			{
				...
				if(npcBody.type == mod.NPCType<Kraken>())
				{
					Body = (Kraken)npcBody.modNPC;
				}
				handType = (int)npc.ai[1];
				npc.localAI[3] = 30 * handType;
			...
			if(Main.netMode != 1)
			{
				...
				if(customAI[0] >= 150 && customAI[3] == 0) //pick random spot to move head to
				{
					...
					npc.netUpdate = true;
					customAI[3] = (Main.rand.Next(3) == 0 ? 1 : 0);
                    ChargeAttack = false;
                }
                else
		...
		public Vector2 GetVariance(bool random = true)
		{
			...
			switch(handType)
			{
				case 0: offsetX = -distFromBodyX - 50; offsetY = -distFromBodyY; break;
				case 1: offsetX = -distFromBodyX - 25; offsetY = 0; break;
				case 2: offsetX = -distFromBodyX; offsetY = distFromBodyY; break;
				case 3: offsetX = distFromBodyX + 50; offsetY = -distFromBodyY; break;
				case 4: offsetX = distFromBodyX + 25; offsetY = 0; break;
