    ...
    public class BlazeGrip : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (timer >= 900)          //After 15 seconds this happens
            {
                ...
                BaseAI.AIEye(npc, ref npc.ai, false, true, 0.1f, 0.04f, 9f, 9f, 1f, 1f);
        ...
        private void DespawnHandler()
        {
            if (!player.active || player.dead)
            {
                ...
                if (player.dead)        // If the player is dead and not active, the npc flies off-screen and despawns
                {
                    npc.alpha -= 10;
                    npc.velocity.X = 0;
                    npc.velocity.Y = 0;
