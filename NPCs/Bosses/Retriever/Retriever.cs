        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] == 6) //shoot lasers right
            {
                ...
                if (Main.netMode != 1)
                {
					...
					{
						BaseAI.ShootPeriodic(npc, targetPlayer.position, targetPlayer.width, targetPlayer.height, mod.ProjectileType<RetrieverShot>(), ref customAI[1], ShootLaserRate, (int)(npc.damage * .25f), 12f, false);
					}
                }
            }else
