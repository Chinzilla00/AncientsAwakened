	...
	public class Lovecraftian : ModNPC
	{
        ...
        public override void OnChatButtonClicked(bool firstButton, ref bool shop)
        {
            ...
            if (!firstButton)
            {
                ...
                int Item1 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Materials.TerraShard>());
                int Item2 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Materials.DragonScale>());
                int Item3 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Materials.MirePod>());
                ...
                int Item7 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Materials.DoomiteScrap>());
                int Item8 = player.FindItem(ItemID.JungleSpores);
                int Item9 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Boss.MushroomMonarch.Mushium>());
                int Item10 = player.FindItem(Terraria.ModLoader.ModContent.ItemType<Items.Boss.MushroomMonarch.GlowingMushium>());
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Materials.TerraShard>();
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Materials.DragonScale>();
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Materials.MirePod>();
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Materials.DoomiteScrap>();
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Boss.MushroomMonarch.Mushium>();
                ...
                {
                    Main.npcChatCornerItem = Terraria.ModLoader.ModContent.ItemType<Items.Boss.MushroomMonarch.GlowingMushium>();
                ...
                {
                    if (!BaseMod.BasePlayer.HasItem(player, Terraria.ModLoader.ModContent.ItemType<Items.Flasks.SquidList>()))
                    {
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)
        {
            if (AAWorld.squid1 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.PurityFlask>());
                nextSlot++;
            }
            if (AAWorld.squid2 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.AshJar>());
                nextSlot++;
            }
            if (AAWorld.squid3 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.DarkwaterFlask>());
                nextSlot++;
            }
            if (AAWorld.squid4 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.CorruptionFlask>());
                nextSlot++;
            }
            if (AAWorld.squid5 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.CrimsonFlask>());
                nextSlot++;
            }
            if (AAWorld.squid6 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.HallowFlask>());
                nextSlot++;
            }
            if (AAWorld.squid7 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.VoidFlask>());
                nextSlot++;
            }
            if (AAWorld.squid8 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.Fungicide>());
                nextSlot++;
            }
            if (AAWorld.squid9 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Usable.SporeSac>());
                nextSlot++;
            }
            if (AAWorld.squid10 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.GlowingSporeSac>());
                nextSlot++;
            }
            if (AAWorld.squid11 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.JungleFlask>());
                nextSlot++;
            }
            if (AAWorld.squid12 >= 1)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.IceFlask>());
                nextSlot++;
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.IcemeltFlask>());
                nextSlot++;
            }
            if (AAWorld.squid13 >= 5)
            {
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Flasks.ForestFlask>());
                nextSlot++;
            }
        }
        ...
        {
            projType = Terraria.ModLoader.ModContent.ProjectileType<EyeShot>();
            attackDelay = 1;
        }
