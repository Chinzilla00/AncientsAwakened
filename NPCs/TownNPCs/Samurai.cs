	...
	public class Samurai : ModNPC
	{
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
        {
            ...
            if (Main.dayTime)
            {
                ...
                nextSlot++;
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Usable.InfernoSeeds>());
                nextSlot++;
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Usable.Sunpowder>());
                nextSlot++;
                if (AAWorld.downedBrood == true)
                {
                    shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.BossSummons.DragonBell>());
            ...
            if (!Main.dayTime)
            {
                ...
                nextSlot++;
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Usable.MireSeeds>());
                nextSlot++;
                shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.Usable.Moonpowder>());
                nextSlot++;
                if (AAWorld.downedHydra == true)
                {
                    shop.item[nextSlot].SetDefaults(Terraria.ModLoader.ModContent.ItemType<Items.BossSummons.HydraChow>());
                    shop.item[nextSlot].value = 100000;
                    nextSlot++;
                }
            }
