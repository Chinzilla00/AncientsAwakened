...
namespace AAMod.NPCs.Enemies.Void
{
    public class Vortex : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            BaseDrawing.DrawTexture(spriteBatch, BladeGlowTex, 0, npc.position, npc.width, npc.height, npc.scale, Rotation, 0, 1, new Rectangle(0, 0, BladeGlowTex.Width, BladeGlowTex.Height), Globals.AAColor.ZeroShield, true);
            BaseDrawing.DrawTexture(spriteBatch, GlowTex, 0, npc.position, npc.width, npc.height, npc.scale, npc.rotation, 0, 1, new Rectangle(0, 0, GlowTex.Width, GlowTex.Height), Globals.AAColor.ZeroShield, true);
            return false;
        }
    }
}