...
{
    public class MiniDjinnCr : ModNPC
	{
        ...
        {
            return spawnInfo.player.ZoneDesert && spawnInfo.player.ZoneCrimson && !spawnInfo.player.ZoneBeach && NPC.downedBoss3 && Main.dayTime ? .1f : 0f;
        }
        ...
        public void FireMagic(NPC npc, Vector2 velocity)
        {
            ...
            BaseAI.FireProjectile(player.Center, npc, 288, (int)(npc.damage * 0.25f), 0f, 2f);
        }
