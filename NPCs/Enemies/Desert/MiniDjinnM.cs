...
{
    public class MiniDjinnM : ModNPC
	{
        ...
        {
            return spawnInfo.player.ZoneDesert && spawnInfo.player.GetModPlayer<AAPlayer>(mod).ZoneMire && !spawnInfo.player.ZoneBeach && NPC.downedBoss3 && Main.dayTime ? .1f : 0f;
        }
        ...
        public void FireMagic(NPC npc, Vector2 velocity)
        {
            ...
            BaseAI.FireProjectile(player.Center, npc, mod.ProjectileType<DjinnAcid>(), (int)(npc.damage * 0.25f), 0f, 2f);
        }
