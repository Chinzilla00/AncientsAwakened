...
namespace AAMod.NPCs.Enemies.Desert
{
    public class DjinnMagic2 : ModProjectile
    {
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, ModContent.DustType<Dusts.InfinityOverloadR>(), -projectile.velocity.X * 0.2f,
                    -projectile.velocity.Y * 0.2f, 100, default, 2f);
                Main.dust[num469].noGravity = true;
                Main.dust[num469].velocity *= 2f;
                num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, ModContent.DustType<Dusts.InfinityOverloadR>(), -projectile.velocity.X * 0.2f,
