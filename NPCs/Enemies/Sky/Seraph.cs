...
namespace AAMod.NPCs.Enemies.Sky
{
	public class Seraph : ModNPC
	{
        ...
        public override void SetDefaults()
        {
            ...
            if (npc.type == Terraria.ModLoader.ModContent.NPCType<SeraphA>())
            {
                npc.alpha = 255;
            }
        }
        ...
        {
            if (npc.type == Terraria.ModLoader.ModContent.NPCType<SeraphA>() && !(NPC.AnyNPCs(Terraria.ModLoader.ModContent.NPCType<Athena>()) || NPC.AnyNPCs(Terraria.ModLoader.ModContent.NPCType<AthenaA>())))
            {
                npc.velocity.Y -= .2f;
                npc.velocity.X *= .95f;
