...
namespace AAMod.NPCs.Enemies.Terrarium
{
    public class Minion4 : ModNPC
	{
        ...
        public override string Texture { get { return "AAMod/NPCs/Enemies/Terrarium/Minion4Head"; } }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0)
                {
                    ...
                    {
                        latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("Minion4Body"), npc.whoAmI, 0, latestNPC);
                        Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                        Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                    }

                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("Minion4Tail"), npc.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
    ...
    {
        public override string Texture { get { return "AAMod/NPCs/Enemies/Terrarium/Minion4Body"; } }
    ...
    {
        public override string Texture { get { return "AAMod/NPCs/Enemies/Terrarium/Minion4Tail"; } }
