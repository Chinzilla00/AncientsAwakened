...
namespace AAMod.NPCs.Enemies.Other
{
    public class Sunwatcher : ModNPC
	{
		...
		{		
			...
			{
				Dust.NewDust(npc.position, npc.width, npc.height, Terraria.ModLoader.ModContent.DustType<DaybringerDust>(), npc.velocity.X * 0.2f, npc.velocity.Y * 0.2f, 100, Color.White, isDead ? 2f : 1.1f);
			}
		}
        ...
        public override void NPCLoot()
        {
            ...
            {
                npc.DropLoot(Terraria.ModLoader.ModContent.ItemType<Items.Materials.Stardust>());
            }
        }
