    ...
    internal class WeakReferences
    {
        ...
        private static void PerformBossChecklistSupport()
        {
            ...
            if (bossChecklist != null)
            {
                ...
                bossChecklist.Call("AddBossWithInfo", "Athena", 11.5f, (Func<bool>)(() => AAWorld.downedToad), Lang.BossCheck("Usean")+"[i:" + AAMod.instance.ItemType("Owl") + "] at the owl altar in the Acropolis.");
                ...
                bossChecklist.Call("AddBossWithInfo", "Athena Rematch", 14.2f, (Func<bool>)(() => AAWorld.downedAthenaA), Lang.BossCheck("Usean")+"[i:" + AAMod.instance.ItemType("Owl") + "] at the owl altar in the Acropolis Post-moon lord.", (Func<bool>)(() => AAWorld.AthenaHerald));
