    ...
    internal class WeakReferences
    {
        ...
        private static void PerformBossChecklistSupport()
        {
            ...
            if (bossChecklist != null)
            {
                ...
                bossChecklist.Call("AddBossWithInfo", "Anubis Legendscribe", 9.5f, (Func<bool>)(() => AAWorld.downedToad), Lang.BossCheck("Usean") + "[i:" + AAMod.instance.ItemType("Scepter") + "]" + "in the desert");
                ...
                bossChecklist.Call("AddBossWithInfo", "Forsaken Anubis", 15f, (Func<bool>)(() => AAWorld.downedToad), "Defeat Anubis post-Moon Lord");
