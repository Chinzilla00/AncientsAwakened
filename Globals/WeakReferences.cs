    ...
    internal class WeakReferences
    {
        ...
        private static void PerformBossChecklistSupport()
        {
            ...
            if (bossChecklist != null)
            {
                ...
                bossChecklist.Call("AddBossWithInfo", "Anubis Legendscribe", 9.5f, (Func<bool>)(() => AAWorld.downedAnubis), Lang.BossCheck("Usean") + "[i:" + AAMod.instance.ItemType("Scepter") + "]" + "in the desert");
                ...
                bossChecklist.Call("AddBossWithInfo", Lang.BossCheck("AthenaA"), 14.2f, (Func<bool>)(() => AAWorld.downedAthenaA), "Defeat Athena post-Moon Lord", (Func<bool>)(() => AAWorld.AthenaHerald));
                bossChecklist.Call("AddBossWithInfo", "Worm King Greed", 14.4f, (Func<bool>)(() => AAWorld.downedGreedA), "Defeat Greed post-Moon Lord", (Func<bool>)(() => AAWorld.AthenaHerald));
                bossChecklist.Call("AddBossWithInfo", "Forsaken Anubis", 15f, (Func<bool>)(() => AAWorld.downedAnubisA), "Defeat Anubis post-Moon Lord");
