            ...
            if (CCBook || CCBookEX)
            {
                ...
                if (slotscanuse > 1)
                {
                    ...
                    if (CCBook)
                    {
                        ...
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.BunnyRune>(), (int)(1 * player.minionDamage), 0, Main.myPlayer, 0f, 0f);
                        }
                        if (player.ownedProjectileCounts[ModContent.ProjectileType<Items.Dev.RuneBook.DiscordRune>()] < 1 && slotscanuse > 2f)
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.DiscordRune>(), (int)(50 * player.minionDamage), 4f, Main.myPlayer, 0f, 0f);
                        }
                        if (player.ownedProjectileCounts[ModContent.ProjectileType<Items.Dev.RuneBook.EnergyRune>()] < 1 && slotscanuse > 3f)
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.EnergyRune>(), (int)(100 * player.minionDamage), 2f, Main.myPlayer, 0f, 0f);
                        }
                    }
                    if (CCBookEX)
                    {
                        ...
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.TerraRune>(), (int)(1 * player.minionDamage), 0, Main.myPlayer, 0f, 0f);
                        }
                        if (player.ownedProjectileCounts[ModContent.ProjectileType<Items.Dev.RuneBook.ChaosRune>()] < 1 && slotscanuse > 2f)
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.ChaosRune>(), (int)(400 * player.minionDamage), 4f, Main.myPlayer, 0f, 0f);
                        }
                        if (player.ownedProjectileCounts[ModContent.ProjectileType<Items.Dev.RuneBook.VoidRune>()] < 1 && slotscanuse > 3f)
                        {
                            if(Main.netMode != 1) Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, ModContent.ProjectileType<Items.Dev.RuneBook.VoidRune>(), (int)(800 * player.minionDamage), 2f, Main.myPlayer, 0f, 0f);
                        }
                    }
                }
            }
